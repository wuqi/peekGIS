...
target("peekgis")
    ...
    add_includedirs("thirdparty/plutovg/include")
    ...
    add_files("thirdparty/plutovg/source/plutovg-blend.c")
    add_files("thirdparty/plutovg/source/plutovg-canvas.c")
    add_files("thirdparty/plutovg/source/plutovg-matrix.c")
    add_files("thirdparty/plutovg/source/plutovg-paint.c")
    add_files("thirdparty/plutovg/source/plutovg-path.c")
    add_files("thirdparty/plutovg/source/plutovg-rasterize.c")
    add_files("thirdparty/plutovg/source/plutovg-surface.c")
    add_files("thirdparty/plutovg/source/plutovg-ft-stroker.c")
    add_files("thirdparty/plutovg/source/plutovg-ft-raster.c")
    add_files("thirdparty/plutovg/source/plutovg-ft-math.c")
    add_files("thirdparty/plutovg/source/plutovg-font.c")
